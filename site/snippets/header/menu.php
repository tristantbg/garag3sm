<div id="menu">
	...
	<div id="menu--la-time">
		<div>
			<div class="time-city tiny bold upper">Los Angeles</div>
			<div class="time lead serif condensed"></div>
			<div class="time-convention tiny bold upper"></div>
		</div>
	</div>
	<div id="menu--fr-time">
		<div>
			<div class="time-city tiny bold upper">Paris</div>
			<div class="time lead serif condensed"></div>
			<div class="time-convention tiny bold upper"></div>
		</div>
	</div>
	...
	<div id="menu--links">
		<ul class="text">
			<li id="sr-basket-widget" class="sr-no-style"><span class="sr-basket-widget-inner" id="sr-basket-button">Cart <span class="sr-confirm-amount"> (0) </span></span></li>
		</ul>
		<ul class="text">
	...
	<div id="menu--board">
		<?php foreach (site()->board()->toStructure() as $key => $item): ?>
			<div class="slide">
				<?php if ($item->image()->isNotEmpty() && $i = $item->image()->toFile()): ?>
				<img class="lazy lazyload lazypreload" data-src="<?= $i->width(600)->url() ?>">
				<?php endif ?>
